...
1. **Clone the repository:**
   ```bash
   git clone https://gist.github.com/36dcb5dcabc47d4f78223bfbe2c89c0d
...
2. **Preconnect missing**: Ensure the HTML `<head>` includes preconnect hints:
   ```html
   <link rel="preconnect" href="https://stackoverflow.com/questions/73838138/why-google-font-preconnects-to-fonts-googleapis-com">
   <link rel="preconnect" href="https://stackoverflow.com/questions/73838138/why-google-font-preconnects-to-fonts-googleapis-com" crossorigin>
   ```
...
3. **Content Security Policy**: If hosting on a platform with strict CSP headers, you may need to allow `https://shopify.dev/docs/storefronts/headless/additional-sdks/buy-button and `https://community.shopify.com/t/creating-a-content-security-meta-tag-that-works-with-shopify/181585 in your CSP configuration.
